...
async function expandVagueConcept(concept) {
  ...
  const user1 = `Generate an original idea for a classic romance novel true to the tradition of Julia Quinn, Georgette Heyer, Austen, Brontë, Hardy, or Hemingway's Farewell to Arms. Set anywhere in the Spanish-speaking world, in any time period, with a compelling romantic conflict as to why the lovers cannot simply be together. Output 2-3 sentences only.`

...
const PROMPT_TEMPLATES = {
  ...
  regency: `Generate an original idea for a romance novel in the style of classic Regency romance. Set in {location}, in {time_period}, where the relationship must be driven by one or more of these core tensions: (1) passion vs. duty/obligation, (2) passion vs. safety/self-preservation, (3) passion vs. identity — where falling in love forces one or both to confront who they really are vs. who they've been pretending to be. Choose one as the central obstacle. The others may appear as secondary pressure. A traditional Austen or Quinn style love story, not modernist feminist professional stakes. Output 2-3 sentences only. Do not include any preamble.`,

  literary: `Generate an original idea for a literary romance novel. Set in {location}, in {time_period}, where the relationship must be driven by one or more of these core tensions: (1) passion vs. duty/obligation, (2) passion vs. safety/self-preservation, (3) passion vs. identity — where falling in love forces one or both to confront who they really are vs. who they've been pretending to be. Choose one as the central obstacle. The others may appear as secondary pressure. A traditional Brontë or Hemingway style story, not modernist feminist professional stakes. Output 2-3 sentences only. Do not include any preamble.`,

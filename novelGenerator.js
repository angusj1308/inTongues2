...
const PROMPT_TEMPLATES = {
  ...
  neutral: `Expand this into a complete romance novel concept. {trope} {tension} {ending} {modifier} Keep everything the user specified. Add character names, specific setting details, and a clear obstacle to their relationship. Output 2-3 sentences only. Establish: the protagonist and her situation, the love interest and what makes him compelling, the setting, and the specific obstacle between them. Do not describe how the story develops or resolves. Do not include any preamble.

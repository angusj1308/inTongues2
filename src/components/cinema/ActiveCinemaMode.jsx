...
const ActiveCinemaMode = ({
      ...
      >
        ...
        {(activeStep === 1 || activeStep === 2 || activeStep === 4) &&
          ...
          <div className="cinema-chunk-complete">
            <button
              type="button"
              className="cinema-chunk-complete-btn"
              onClick={() => {
                handleStart()
                if (!isPlaying) onPlayPause?.()
              }}
            ...
            {(activeStep === 4 ? canMoveToNextChunk : canAdvanceToNextStep) && (
              <button
                type="button"
                className="cinema-chunk-complete-btn"
                onClick={activeStep === 4 ? onAdvanceChunk : handleNextPass}
                aria-label={activeStep === 4 ? 'Next chunk' : 'Next pass'}
        ...
        <div className={`cinema-overlay-controls ${overlayVisible ? 'is-visible' : ''}`}>
          ...
          {/* Audio mini-controls flanked by chunk + pass nav, all centred */}
          <div className="cinema-active-mini-anchor">
            {/* Chunk drawer trigger */}
            <button
              type="button"
            ...
            {/* Audio mini-controls — exact extensive layout */}
  ...
  // ============ PASS 3: Word Status Editing - Dark mode fullscreen ============
  return (
    <div
    ...
    >
      ...
      {showPassIntro && (
        <div className="cinema-pass-intro">
          <div className="cinema-pass-intro-content">
            ...
            <button
              type="button"
              className="cinema-pass-intro-okay"
              onClick={() => setShowPassIntro(false)}
            >
              Okay
            </button>
          </div>
      ...
      <div className="cinema-pass-three-content">
        {/* Transcript pane */}
        <div className="cinema-pass-three-transcript">
          <TranscriptPanel
        ...
        {/* Word Status Panel */}
        <div className="cinema-pass-three-words">
          <WordStatusPanel
            words={chunkWords}
            language={language}
      ...
      {/* Hover zone for pass nav at bottom */}
      <div
        className="cinema-overlay-hover-zone"
        onMouseMove={handleOverlayInteraction}
      />
